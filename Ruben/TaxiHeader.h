...
//-------------------------------------------------------------------------
    ...
    int SO_SOURCES; //num celle origine taxi (<= W x H - HOLES )
    int SO_TAXI;
...
//??? a questo punto non ci serve visto che la matrice è condivisa in memoria??
void assignMat(struct cella A[SO_HEIGHT][SO_WIDTH], struct cella B[SO_HEIGHT][SO_WIDTH]); //per copiare matrici
