...
int main(int argc, char *argv[]){
    ...
    //mi sincronizzo alla memoria condivisa
        ...
        //for(i=0;i<2;i++){
            ...
            switch(fork()){ //solo 1 volta xk 1 taxi, SE NO SO_TAXI VOLTE
                ...
                case 0: //è il figlio TAXI
                    ...
                    cercaSource(coordSource, ptMemCond->mappa); //Cerco una casella con la sorgente
                    ...
                    if((infoTaxi.coordTaxi[0] == coordSource[0]) && (infoTaxi.coordTaxi[1] == coordSource[1])){     //Se le coordinate sono diverse, faccio raggiungere la sorgente dal taxi
                        ...
                        if(valid = TaxiMover(ptMemCond->mappa, &infoTaxi, coordSource[0], coordSource[1], &infoTaxi.tempoImpiegato) == 1){                            
